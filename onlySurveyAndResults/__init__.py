...
class SpeederRedirect(Page):
    ...
    def js_vars(player):
        ...
        redirect_url = f"https://survey.maximiles.com/speeder?p=158041&m={bilendi_id}"
...
class FinalRedirect(Page):
    ...
    def js_vars(player):
        bilendi_id = player.participant.label
        redirect_url = f"https://survey.maximiles.com/complete?p=158041_1e6c55a3&m={bilendi_id}"
        return dict(redirect_url=redirect_url)
