...
SESSION_CONFIG_DEFAULTS = dict(
    real_world_currency_per_point=1.00, participation_fee=2.00,student_debug=False, doc="",current_participants=0
)

PARTICIPANT_FIELDS = ["treeOrder","easyFirst","total_correct_answers"]
SESSION_FIELDS = ['participants_needed','current_participants']
